      ...
      <div className="text-white font-sans font-bold container bg-white mx-auto text-center">
                <div className="grid grid-rows-6 items-center mx-auto text-center">
                    ...
                    <div className="row-span-4 row-start-1 col-auto text-black mx-auto">
                        <img className="w-52 mb-5 mt-10 ml-10" src={Logo}></img>
                    ...
                    <div className="text-sm font-sans font-medium w-full pr-20 pt-5 text-center">
                        <button 
                            type="button"   
                            className="text-center w-full py-4 bg-primary hover:bg-purple-800 rounded-md text-white shadow-lg rounded-2xl">
                                REGISTER
                        </button>
