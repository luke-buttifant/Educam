...
return(
    ...
    <div className="w-40 h-7 flex items-center bg-gray-300 dark:bg-black rounded-full mx-3 px-1  cursor-pointer" onClick={toggleTheme}>
        <div  id='lightModeToggle' className="dark:bg-dark-mode w-16 h-5 rounded-full shadow-md transform dark:ml-16 hover:bg-primary bg-white animate-pulse"></div>
    </div>
    <span className="">
        <svg className="h-6 w-6 text-primary dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
